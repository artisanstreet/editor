...
impl Window {
    ...
    ///
    /// The blur applies to content painted behind `bounds` and is clipped to `corner_radii`.
    /// Renderers without blur support skip these primitives without failing the frame.
    ///
    /// This method should only be called as part of the paint phase of element drawing.
