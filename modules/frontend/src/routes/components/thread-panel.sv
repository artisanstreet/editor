<script lang="ts" effect>
	...
	import ProjectFolderPicker from "./project-folder-picker.sv";
	import ShaderGlassSurface from "./shader-glass-surface.sv";
	import ProjectSelector from "./panel/project-selector.sv";
	import ShaderSettings from "./panel/shader-settings.sv";
