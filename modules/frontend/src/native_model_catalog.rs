...
//! explicit validation instead of deriving a second schema: the frontend
//! does not need to own the catalog schema, but it does need to preserve every
//! capability field and reject malformed or unsupported selections.
