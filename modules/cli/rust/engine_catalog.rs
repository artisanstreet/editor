...
pub(crate) fn register_profile(
    ...
    authority
        ...
        .map_err(map_authority_profile_error)?;
...
fn derived_profile_home(
    ...
    let engine_root = managed_paths(instance, CERTIFIED_ENGINE_ID)
...
fn validate_profile_registry(
    ...
    if document.engine_id != CERTIFIED_ENGINE_ID {
...
fn encode_profile_registry(
    ...
    let document = ProfileRegistryDocument {
        engine_id: CERTIFIED_ENGINE_ID.to_owned(),
...
fn map_authority_profile_error(_error: NativeOpenCode2Error) -> NativeOpenCode2ProfileError {
