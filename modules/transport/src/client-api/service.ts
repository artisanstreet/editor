...
export class ArtisanClient extends Context.Service<
  ArtisanClient,
  {
    ...
    readonly GetTelemetryPreferences?: Effect.Effect<TelemetryPreferences, ArtisanClientError>;
    readonly UpdateTelemetryPreferences?: (
      input: TelemetryPreferencesUpdate,
    ) => Effect.Effect<TelemetryPreferences, ArtisanClientError>;
    readonly CaptureTelemetryIntent?: (
      input: TelemetryIntent,
    ...
    readonly PickProjectDirectory: Effect.Effect<ProjectDirectoryPickResult, ArtisanClientError>;
