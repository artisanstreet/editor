  ...
  return Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const requests = yield* make_client_request_coordinator(
        ...
        undefined,
        connection.RetireTimedOutRequest,
      );
      ...
      const workspace_api = yield* MakeClientApi(MakeWorkspaceApi, connection, requests, runtime);
      ...
      const guidance_api = yield* MakeClientApi(MakeGuidanceApi, connection, requests, runtime);
      const capability_api = yield* MakeClientApi(MakeCapabilityApi, connection, requests, runtime);
      return {
        Command: command,
        ...
        GetTelemetryPreferences: get_telemetry_preferences,
        UpdateTelemetryPreferences: update_telemetry_preferences,
        CaptureTelemetryIntent: capture_telemetry_intent,
        ...
        GetProjectIdentities: get_project_identities,
        ...
        RefreshCapabilityOAuth: (input) =>
          capability_api.capability_oauth_mutation(input, "marketplace.capability.oauth.refresh"),
        RevokeCapabilityOAuth: (input) =>
          capability_api.capability_oauth_mutation(input, "marketplace.capability.oauth.revoke"),
        ...
        SubscribeThreadWork: subscriptions.SubscribeThreadWork,
