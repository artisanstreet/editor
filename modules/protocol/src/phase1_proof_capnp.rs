...
// DO NOT EDIT.
// source: phase1_proof.capnp
// capnp binary version: 1.1.0
// capnpc crate version: 0.27.0


pub mod phase1_proof_envelope {
    #[derive(Copy, Clone)]
    pub struct Owned(());
    ...
    impl <'a,> Reader<'a,>  {
        ...
        #[inline]
        pub fn get_payload(self) -> ::capnp::Result<::capnp::text::Reader<'a>> {
        ...
        #[inline]
        pub fn get_attempt_numbers(self) -> ::capnp::Result<::capnp::primitive_list::Reader<'a,u32>> {
            ::capnp::traits::FromPointerReader::get_from_pointer(&self.reader.get_pointer_field(1), ::core::option::Option::None)
        }
        #[inline]
        pub fn has_attempt_numbers(&self) -> bool {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_correlation_id(&mut self, value: u64)  {
            self.builder.set_data_field::<u64>(0, value);
        }
        #[inline]
        pub fn get_payload(self) -> ::capnp::Result<::capnp::text::Builder<'a>> {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(0), ::core::option::Option::None)
        }
        #[inline]
        pub fn set_payload(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::text::Owned>)  {
            ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(0), value, false).unwrap()
        }
        #[inline]
        pub fn init_payload(self, size: u32) -> ::capnp::text::Builder<'a> {
        ...
        #[inline]
        pub fn get_attempt_numbers(self) -> ::capnp::Result<::capnp::primitive_list::Builder<'a,u32>> {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
        }
        #[inline]
        pub fn set_attempt_numbers(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::primitive_list::Owned<u32>>) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
        }
        #[inline]
        pub fn init_attempt_numbers(self, size: u32) -> ::capnp::primitive_list::Builder<'a,u32> {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 71] = [
            ...
            ::capnp::word(200, 98, 96, 198, 190, 231, 47, 153),
            ::capnp::word(19, 0, 0, 0, 1, 0, 1, 0),
            ::capnp::word(46, 140, 31, 75, 231, 92, 61, 169),
            ::capnp::word(2, 0, 7, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(169, 1, 0, 0, 26, 2, 0, 0),
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(112, 104, 97, 115, 101, 49, 95, 112),
            ::capnp::word(114, 111, 111, 102, 46, 99, 97, 112),
            ::capnp::word(110, 112, 58, 80, 104, 97, 115, 101),
            ::capnp::word(49, 80, 114, 111, 111, 102, 69, 110),
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(97, 116, 116, 101, 109, 112, 116, 78),
            ::capnp::word(117, 109, 98, 101, 114, 115, 0, 0),
        ...
        pub(crate) const TYPE_ID: u64 = 0x992f_e7be_c660_62c8;
    }
}
