...
/** Supplies one decoded Claude stream-json event to the canonical normalizer. @since 0.4.0 */
...
/** Classifies every documented Claude fatal event without exposing private reasoning. @since 0.4.0 */
...
/** Reads the provider session identity from a validated Claude event envelope. @since 0.4.0 */
...
/** Identifies the required Claude initialization event after schema validation. @since 0.4.0 */
...
/** Normalizes documented Claude events with schema validation and raw-frame provenance. @since 0.4.0 */
