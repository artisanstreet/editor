...
- [x] Latest verified implementation checkpoint: `f689a56 feat: probe local previews`
- [x] Local `HEAD`, its upstream, and `origin/codex/workspace-replace-approval` must be equal after every checkpoint push and before handoff; this was last verified on 2026-07-15 at `f689a56 feat: probe local previews`.
...
- [ ] Add binary asset routes and the external-browser inspection lifecycle.
