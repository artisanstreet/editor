...
- [x] Replaced the selector dropdown's inherited ring/shadow outline with an important Barekey `card` utility so the outer surface uses the shared card treatment rather than a border.
