...
- [x] Latest verified implementation checkpoint: `4d26a28 feat: expose git mutations to renderer`
- [x] Local `HEAD`, upstream, and `origin/codex/workspace-replace-approval` were equal at `4d26a28` after the local full-repository validation passed on 2026-07-14.
...
- [ ] Next backend slice: add an external parent-process crash harness proving an incomplete Git execution is quarantined and keeps the workspace fenced across restart without re-execution.
