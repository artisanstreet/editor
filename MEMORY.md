...
- [x] Latest verified implementation checkpoint: `a4f6572 feat: expose external wait controls`
- [x] Local `HEAD`, its upstream, and `origin/codex/workspace-replace-approval` must be equal after every checkpoint push and before handoff; this was last verified on 2026-07-14 after the external-wait application, protocol, and typed client checkpoint was pushed.
