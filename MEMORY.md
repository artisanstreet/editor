...
- [x] Strengthened the accepted spotlight without changing its geometry or blur: raised both gradient layers and the alpha-mask transmission so the selected logo receives a clearer beam while retaining the diffused source and edge falloff.
