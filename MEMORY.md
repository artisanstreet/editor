...
- [x] Latest verified implementation checkpoint: `fea2e45 test: prove external browser recovery`
- [x] Local `HEAD`, its upstream, and `origin/codex/workspace-replace-approval` must be equal after every checkpoint push and before handoff; this was last verified on 2026-07-15 at `fea2e45 test: prove external browser recovery`.
