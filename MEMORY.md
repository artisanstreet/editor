...
- [x] Latest verified implementation checkpoint: `7a0d068 feat: clone GitHub repositories safely`
...
- [ ] Compose the hosted-project clone coordinator into the backend runtime and protocol server, wire real thread-erasure fencing and cleanup, expose renderer client methods, and add MessagePort/restart integration coverage. Independent persistence review found these production wiring tasks as the remaining P1/P2 gap; the repository mechanics themselves were clean.
