...
- [x] Latest verified implementation checkpoint: `a8302f5 test: prove rich-link transport recovery`
- [x] Local `HEAD`, its upstream, and `origin/codex/workspace-replace-approval` must be equal after every checkpoint push and before handoff; this was last verified on 2026-07-15 at `a8302f5 test: prove rich-link transport recovery`.
...
- [ ] Add the external-browser inspection lifecycle.
