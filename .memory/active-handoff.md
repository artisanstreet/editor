...
- Streaming repair remains for prose finalization/late mounts. The Waiting slice passes focused tests/review/lint/type/build/native. Full gate has unrelated scrollbar format, two stale participant-window assertions, and two persistent Claude CLI timeouts.
